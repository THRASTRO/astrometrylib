...
GSL_FUN long double gsl_stats_long_double_select(long double data[], const size_t stride, const size_t n, const size_t k);
...
GSL_FUN double gsl_stats_long_double_median (long double sorted_data[], const size_t stride, const size_t n);
...
GSL_FUN double gsl_stats_long_double_trmean_from_sorted_data (const double trim, const long double sorted_data[], const size_t stride, const size_t n) ;
GSL_FUN double gsl_stats_long_double_gastwirth_from_sorted_data (const long double sorted_data[], const size_t stride, const size_t n) ;

GSL_FUN double gsl_stats_long_double_mad0(const long double data[], const size_t stride, const size_t n, double work[]);
GSL_FUN double gsl_stats_long_double_mad(const long double data[], const size_t stride, const size_t n, double work[]);

GSL_FUN long double gsl_stats_long_double_Sn0_from_sorted_data (const long double sorted_data[], const size_t stride, const size_t n, long double work[]) ;
GSL_FUN double gsl_stats_long_double_Sn_from_sorted_data (const long double sorted_data[], const size_t stride, const size_t n, long double work[]) ;

GSL_FUN long double gsl_stats_long_double_Qn0_from_sorted_data (const long double sorted_data[], const size_t stride, const size_t n, long double work[], int work_int[]) ;
GSL_FUN double gsl_stats_long_double_Qn_from_sorted_data (const long double sorted_data[], const size_t stride, const size_t n, long double work[], int work_int[]) ;
