...
GSL_FUN int gsl_matrix_long_tricpy(CBLAS_UPLO_t Uplo, CBLAS_DIAG_t Diag, gsl_matrix_long * dest, const gsl_matrix_long * src);
...
GSL_FUN int gsl_matrix_long_transpose_tricpy (CBLAS_UPLO_t Uplo_src, CBLAS_DIAG_t Diag, gsl_matrix_long * dest, const gsl_matrix_long * src);
...
GSL_FUN long gsl_matrix_long_norm1 (const gsl_matrix_long * m);
...
GSL_FUN int gsl_matrix_long_scale_rows (gsl_matrix_long * a, const gsl_vector_long * x);
GSL_FUN int gsl_matrix_long_scale_columns (gsl_matrix_long * a, const gsl_vector_long * x);
