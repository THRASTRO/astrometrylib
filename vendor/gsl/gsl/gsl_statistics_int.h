...
GSL_FUN int gsl_stats_int_select(int data[], const size_t stride, const size_t n, const size_t k);

GSL_FUN double gsl_stats_int_median_from_sorted_data (const int sorted_data[], const size_t stride, const size_t n) ;
GSL_FUN double gsl_stats_int_median (int sorted_data[], const size_t stride, const size_t n);
...
GSL_FUN double gsl_stats_int_trmean_from_sorted_data (const double trim, const int sorted_data[], const size_t stride, const size_t n) ;
GSL_FUN double gsl_stats_int_gastwirth_from_sorted_data (const int sorted_data[], const size_t stride, const size_t n) ;

GSL_FUN double gsl_stats_int_mad0(const int data[], const size_t stride, const size_t n, double work[]);
GSL_FUN double gsl_stats_int_mad(const int data[], const size_t stride, const size_t n, double work[]);

GSL_FUN int gsl_stats_int_Sn0_from_sorted_data (const int sorted_data[], const size_t stride, const size_t n, int work[]) ;
GSL_FUN double gsl_stats_int_Sn_from_sorted_data (const int sorted_data[], const size_t stride, const size_t n, int work[]) ;

GSL_FUN int gsl_stats_int_Qn0_from_sorted_data (const int sorted_data[], const size_t stride, const size_t n, int work[], int work_int[]) ;
GSL_FUN double gsl_stats_int_Qn_from_sorted_data (const int sorted_data[], const size_t stride, const size_t n, int work[], int work_int[]) ;
