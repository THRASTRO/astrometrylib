...
GSL_FUN int gsl_vector_long_scale (gsl_vector_long * a, const long x);
GSL_FUN int gsl_vector_long_add_constant (gsl_vector_long * a, const double x);
GSL_FUN int gsl_vector_long_axpby (const long alpha, const gsl_vector_long * x, const long beta, gsl_vector_long * y);
GSL_FUN long gsl_vector_long_sum (const gsl_vector_long * a);
