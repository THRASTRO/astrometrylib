...
GSL_FUN short gsl_stats_short_select(short data[], const size_t stride, const size_t n, const size_t k);

GSL_FUN double gsl_stats_short_median_from_sorted_data (const short sorted_data[], const size_t stride, const size_t n) ;
GSL_FUN double gsl_stats_short_median (short sorted_data[], const size_t stride, const size_t n);
...
GSL_FUN double gsl_stats_short_trmean_from_sorted_data (const double trim, const short sorted_data[], const size_t stride, const size_t n) ;
GSL_FUN double gsl_stats_short_gastwirth_from_sorted_data (const short sorted_data[], const size_t stride, const size_t n) ;

GSL_FUN double gsl_stats_short_mad0(const short data[], const size_t stride, const size_t n, double work[]);
GSL_FUN double gsl_stats_short_mad(const short data[], const size_t stride, const size_t n, double work[]);

GSL_FUN short gsl_stats_short_Sn0_from_sorted_data (const short sorted_data[], const size_t stride, const size_t n, short work[]) ;
GSL_FUN double gsl_stats_short_Sn_from_sorted_data (const short sorted_data[], const size_t stride, const size_t n, short work[]) ;

GSL_FUN short gsl_stats_short_Qn0_from_sorted_data (const short sorted_data[], const size_t stride, const size_t n, short work[], int work_int[]) ;
GSL_FUN double gsl_stats_short_Qn_from_sorted_data (const short sorted_data[], const size_t stride, const size_t n, short work[], int work_int[]) ;
