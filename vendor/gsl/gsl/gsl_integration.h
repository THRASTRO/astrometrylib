...
GSL_FUN gsl_integration_glfixed_table * gsl_integration_glfixed_table_alloc (size_t n);

GSL_FUN void gsl_integration_glfixed_table_free (gsl_integration_glfixed_table * t);

/* Routine for fixed-order Gauss-Legendre integration */

GSL_FUN double gsl_integration_glfixed (const gsl_function *f,
                                double a,
                                double b,
...
GSL_FUN int gsl_integration_glfixed_point (double a,
                                   double b,
                                   size_t i,
                                   double *xi,
                                   double *wi,
...
GSL_FUN gsl_integration_romberg_workspace *gsl_integration_romberg_alloc(const size_t n);
GSL_FUN void gsl_integration_romberg_free(gsl_integration_romberg_workspace * w);
GSL_FUN int gsl_integration_romberg(const gsl_function * f, const double a, const double b,
