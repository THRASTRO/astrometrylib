...
GSL_FUN unsigned char gsl_stats_uchar_select(unsigned char data[], const size_t stride, const size_t n, const size_t k);
...
GSL_FUN double gsl_stats_uchar_median (unsigned char sorted_data[], const size_t stride, const size_t n);
...
GSL_FUN double gsl_stats_uchar_trmean_from_sorted_data (const double trim, const unsigned char sorted_data[], const size_t stride, const size_t n) ;
GSL_FUN double gsl_stats_uchar_gastwirth_from_sorted_data (const unsigned char sorted_data[], const size_t stride, const size_t n) ;

GSL_FUN double gsl_stats_uchar_mad0(const unsigned char data[], const size_t stride, const size_t n, double work[]);
GSL_FUN double gsl_stats_uchar_mad(const unsigned char data[], const size_t stride, const size_t n, double work[]);

GSL_FUN unsigned char gsl_stats_uchar_Sn0_from_sorted_data (const unsigned char sorted_data[], const size_t stride, const size_t n, unsigned char work[]) ;
GSL_FUN double gsl_stats_uchar_Sn_from_sorted_data (const unsigned char sorted_data[], const size_t stride, const size_t n, unsigned char work[]) ;

GSL_FUN unsigned char gsl_stats_uchar_Qn0_from_sorted_data (const unsigned char sorted_data[], const size_t stride, const size_t n, unsigned char work[], int work_int[]) ;
GSL_FUN double gsl_stats_uchar_Qn_from_sorted_data (const unsigned char sorted_data[], const size_t stride, const size_t n, unsigned char work[], int work_int[]) ;
