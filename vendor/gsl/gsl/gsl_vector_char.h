...
GSL_FUN int gsl_vector_char_scale (gsl_vector_char * a, const char x);
GSL_FUN int gsl_vector_char_add_constant (gsl_vector_char * a, const double x);
GSL_FUN int gsl_vector_char_axpby (const char alpha, const gsl_vector_char * x, const char beta, gsl_vector_char * y);
GSL_FUN char gsl_vector_char_sum (const gsl_vector_char * a);
