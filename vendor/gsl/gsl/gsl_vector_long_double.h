...
GSL_FUN int gsl_vector_long_double_scale (gsl_vector_long_double * a, const long double x);
GSL_FUN int gsl_vector_long_double_add_constant (gsl_vector_long_double * a, const double x);
GSL_FUN int gsl_vector_long_double_axpby (const long double alpha, const gsl_vector_long_double * x, const long double beta, gsl_vector_long_double * y);
GSL_FUN long double gsl_vector_long_double_sum (const gsl_vector_long_double * a);

GSL_FUN int gsl_vector_long_double_equal (const gsl_vector_long_double * u, 
