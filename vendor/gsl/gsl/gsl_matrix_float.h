...
GSL_FUN int gsl_matrix_float_tricpy(CBLAS_UPLO_t Uplo, CBLAS_DIAG_t Diag, gsl_matrix_float * dest, const gsl_matrix_float * src);
...
GSL_FUN int gsl_matrix_float_transpose_tricpy (CBLAS_UPLO_t Uplo_src, CBLAS_DIAG_t Diag, gsl_matrix_float * dest, const gsl_matrix_float * src);
...
GSL_FUN float gsl_matrix_float_norm1 (const gsl_matrix_float * m);
...
GSL_FUN int gsl_matrix_float_scale_rows (gsl_matrix_float * a, const gsl_vector_float * x);
GSL_FUN int gsl_matrix_float_scale_columns (gsl_matrix_float * a, const gsl_vector_float * x);
