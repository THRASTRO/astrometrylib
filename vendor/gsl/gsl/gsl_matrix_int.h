...
GSL_FUN int gsl_matrix_int_tricpy(CBLAS_UPLO_t Uplo, CBLAS_DIAG_t Diag, gsl_matrix_int * dest, const gsl_matrix_int * src);
...
GSL_FUN int gsl_matrix_int_transpose_tricpy (CBLAS_UPLO_t Uplo_src, CBLAS_DIAG_t Diag, gsl_matrix_int * dest, const gsl_matrix_int * src);
...
GSL_FUN int gsl_matrix_int_norm1 (const gsl_matrix_int * m);
...
GSL_FUN int gsl_matrix_int_scale_rows (gsl_matrix_int * a, const gsl_vector_int * x);
GSL_FUN int gsl_matrix_int_scale_columns (gsl_matrix_int * a, const gsl_vector_int * x);
