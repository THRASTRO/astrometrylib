...
GSL_FUN int gsl_vector_ushort_scale (gsl_vector_ushort * a, const unsigned short x);
GSL_FUN int gsl_vector_ushort_add_constant (gsl_vector_ushort * a, const double x);
GSL_FUN int gsl_vector_ushort_axpby (const unsigned short alpha, const gsl_vector_ushort * x, const unsigned short beta, gsl_vector_ushort * y);
GSL_FUN unsigned short gsl_vector_ushort_sum (const gsl_vector_ushort * a);
